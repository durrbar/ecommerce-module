...
use Modules\Ecommerce\Http\Requests\ResourceCreateRequest;
use Modules\Ecommerce\Http\Requests\ResourceUpdateRequest;
use Modules\Ecommerce\Models\Resource;
use Modules\Ecommerce\Repositories\ResourceRepository;
